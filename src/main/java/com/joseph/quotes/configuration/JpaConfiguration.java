package com.joseph.quotes.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.joseph.quotes.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.joseph.quotes.model" });
